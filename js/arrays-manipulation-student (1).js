...
// var cheeses = ['Brie', 'Red Wine', 'Smoked Havarti'];
// console.log(cheeses);
// // ['Brie', 'Red Wine', 'Smoked Havarti']
//
// // let's add 'English Cheddar' to the beginning of the week
// cheeses.unshift('English Cheddar');
// console.log(cheeses);
// //['Brie', 'Red Wine', 'Smoked Havarti']
//
// ['English Cheddar', 'Brie', 'Red Wine', 'Smoked Havarti'];
//
// // let's add 'Bleu Cheese' and 'Red Wine' to the end of the week
// cheeses.push('Bleu Cheese', 'Red Wine');
//
// console.log(cheeses);
// ['English Cheddar', 'Brie', 'Red Wine', 'Smoked Havarti'];
