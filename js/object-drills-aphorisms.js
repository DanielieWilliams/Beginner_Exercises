...
{
    console.log('"' + fiveQuotes[0].quote + '" ' + fiveQuotes[0].author);
    console.log('"' + fiveQuotes[1].quote + '" ' + fiveQuotes[1].author);
    console.log('"' + fiveQuotes[2].quote + '" ' + fiveQuotes[2].author);
    console.log('"' + fiveQuotes[3].quote + '" ' + fiveQuotes[3].author);
    console.log('"' + fiveQuotes[4].quote + '" ' + fiveQuotes[4].author);
